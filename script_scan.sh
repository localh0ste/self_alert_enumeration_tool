...
figlet -f slant Localh0ste
echo -e  "\\033[31mPROJECT MADE BY localh0ste ~vikram \\033[0m"
GREEN='\033[0;32m'
echo -e "\n${GREEN} ........Self Alert Automatic Enumeration Tool ......\n"


# Check if an IP address is provided as an argument
if [ -z "$1" ]; then
    echo "Usage: $0 <website or domain only>"
    exit 1
fi
# Prompt for email
